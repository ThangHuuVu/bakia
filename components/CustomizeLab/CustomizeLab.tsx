            ...
            >
              ...
              {isOverviewOpen && (
                <div className="flex flex-col items-center gap-4 px-4 mt-10 overflow-y-hidden">
                  ...
                  <p>
                    Các Bakia được customize sẽ có thời gian ra đời lâu hơn do được sản xuất hoàn
                    toàn dành riêng cho bạn. Bakia sau khi customize không thể được đổi trả. Trường
                    hợp Bakia bị lỗi vui lòng liên hệ chúng tôi để được giải quyết.
                  </p>
                </div>
              )}
